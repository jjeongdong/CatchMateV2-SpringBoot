package com.back.catchmate.global.authorization.aspect;
...
public class DataPermissionAspect {
    ...
    // 커스텀 어노테이션들을 모두 감지
    @Before("@annotation(com.back.catchmate.global.authorization.annotation.CheckBoardPermission) || " +
            "@annotation(com.back.catchmate.global.authorization.annotation.CheckEnrollApplicantPermission) || " +
            "@annotation(com.back.catchmate.global.authorization.annotation.CheckEnrollHostPermission) || " +
            "@annotation(com.back.catchmate.global.authorization.annotation.CheckNotificationPermission) || " +
            "@annotation(com.back.catchmate.global.authorization.annotation.CheckInquiryPermission)")
