...
public interface JpaNotificationOutboxRepository extends JpaRepository<NotificationOutboxEntity, Long> {
    ...
    Optional<NotificationOutboxEntity> findByRecipientIdAndReferenceTypeAndReferenceIdAndStatus(
            Long recipientId, ReferenceType referenceType, Long referenceId, OutboxStatus status
    );
}
